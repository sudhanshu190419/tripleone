  ...
  return (
    <section className="py-8 sm:py-14 lg:py-16">
      <div className="mx-auto max-w-[1480px] px-4 sm:px-6 lg:px-8">
        <div className="rounded-2xl bg-[#FCF7F0] px-4 py-8 sm:px-8 sm:py-14 lg:px-16 lg:py-16">
          ...
          <div className="mx-auto max-w-5xl text-center">
            ...
            <p className="mx-auto mt-3 max-w-3xl text-[13px] sm:text-[16px] lg:text-[18px] leading-[1.75] text-[#6D6258]">
            ...
            <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
              ...
              <span className="inline-flex items-center justify-center rounded-full bg-[#241E1B] px-5 sm:px-7 py-3 text-[11px] sm:text-[13px] font-semibold text-white text-center shadow-[0_10px_18px_rgba(36,30,27,0.18)] w-full sm:w-auto">
                4 reasons guests book with confidence
              </span>

              <span className="inline-flex items-center justify-center rounded-full bg-[#E8DDD2] px-5 sm:px-7 py-3 text-[11px] sm:text-[13px] font-medium text-[#3C332D] text-center w-full sm:w-auto">
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 sm:mt-12 sm:grid-cols-2 xl:grid-cols-4">
            {reasons.map((reason, index) => {
              ...
              return (
                <article
                  key={reason.title}
                  className="group rounded-[18px] bg-[#FCF7F0] px-4 py-5 sm:px-5 sm:py-7 transition-all duration-200 hover:-translate-y-0.5"
                  style={{
                ...
                >
                  {/* Icon */}
                  <div className="mb-3 flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-[#F4D7C7] text-[#7F4A2D] transition-transform duration-200 group-hover:scale-105">
                    <Icon size={17} strokeWidth={2} />
                  </div>

                  {/* Title */}
                  <h3
                    className="text-[18px] sm:text-[23px] font-semibold leading-[1.08] tracking-[-0.03em] text-[#16110E]"
                    style={{
                      fontFamily:
                  ...
                  {/* Description */}
                  <p className="mt-2 text-[13px] sm:text-[15px] leading-[1.65] text-[#6B5F56]">
                    {reason.description}
                  </p>
                </article>
              );
